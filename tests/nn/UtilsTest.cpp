...
TEST(UtilsTest, PadSequence) {
  // Empty vector
  auto empty = padSequence({});
  ASSERT_TRUE(empty.isempty());

  // Single array
  auto i = af::randu(50, 60, 70);
  auto o = padSequence({i}, -1, 3);
