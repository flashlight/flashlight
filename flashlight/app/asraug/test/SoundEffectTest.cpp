 ...
 * range. This test first gereta a sine-wave with amplitude of 2.0 then clamp it
 ...
 * [-1..1] range. This test first gereta a sine-wave with amplitude of 2.0 then
 * normalizes it and verifies the result.
 */
