...
af_interp_type flToAfInterpType(InterpolationMode mode) {
  switch (mode) {
...
/* unused */ bool ArrayFireVisionExtensionIsRegistered =
    ::fl::registerTensorExtension<ArrayFireVisionExtension>(
