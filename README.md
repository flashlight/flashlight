...
make install
```
Setting the `MKLROOT` environment variable (`export MKLROOT=/opt/intel/oneapi/mkl/latest` on most Linux-based systems) can help CMake find Intel MKL if not initially found. 
